    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "439608239719433",
               appSecret: "1d18fea13fd93a047355a6509265f26a");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "55133927595-mer9f7dloo45d8fl4g34run1vdh0elfv.apps.googleusercontent.com",
                ClientSecret = "YI-3Yg0qq8z4nhENkLHjmnyi"
            });
        }
