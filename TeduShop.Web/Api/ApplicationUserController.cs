    ...
    public class ApplicationUserController : ApiControllerBase
    {
        ...
        public HttpResponseMessage Details(HttpRequestMessage request, string id)
        {
            ...
            else
            {
                ...
                var applicationUserViewModel = user.Result.ToViewModel();
                ...
                applicationUserViewModel.Groups = listGroup.ToListViewModel();
        ...
        public async Task<HttpResponseMessage> Create(HttpRequestMessage request, ApplicationUserViewModel applicationUserViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                //var newAppUser = applicationUserViewModel.ToModel();
                try
                {
        ...
        public async Task<HttpResponseMessage> Update(HttpRequestMessage request, ApplicationUserViewModel applicationUserViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    //var appUser = applicationUserViewModel.ToModel();
